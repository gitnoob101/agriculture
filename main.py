...
# --- PART 1: FastAPI App and AI Client Initialization ---
...
# --- PART 2: Pydantic Models for API Input Validation ---
...
# --- PART 3: Weather Data Fetching and Formatting ---
...
# --- PART 4: Dhenu 2 LLM Integration for Advisory ---
...
# --- PART 5: Proactive Sales Agent (/setuAgent) Logic ---
...
async def detect_plant_disease(
    ...
    """Accepts an image for disease detection using Gemini model."""
    ...
    try:
        ...
        analysis_text = "Could not analyze the image. Please ensure your Google API key is set correctly."
...
async def get_general_advisory(location: Location):
    ...
    try:
        farm_data = get_weather_forecast(location.latitude, location.longitude)
    except Exception as e:
    ...
    formatted_data = format_data_for_llm(farm_data)
    ...
    advisory = await get_dhenu_advisory(master_prompt)
...
async def run_sales_agent(profile: FarmerProfile):
    ...
    with contextlib.redirect_stdout(output_buffer):
        ...
        run_proactive_agent(farmer_details)
